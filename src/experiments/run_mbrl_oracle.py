...
from learning.core_learner.mbrl_oracle_decoder import MBRLOracleDecoder
...
def main():
    ...
    for exp_id in range(1, num_runs + 1):
        ...
        learning_alg = MBRLOracleDecoder(exp_setup)

        policy_result = learning_alg.train(env=env, exp_id=exp_id)
