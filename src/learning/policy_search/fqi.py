...
class FQI(AbstractPolicySearch):
    ...
    def do_train(config, constants, homing_policy_dataset, env_info, policy_folder_name, actions, horizon,
        ...
        learned_policy, mean_reward, _ = fqi.train(homing_policy_dataset, env, actions, horizon, reward_func,
    ...
    def train(self, replay_memory, env, actions, horizon, reward_func, homing_policies, logger, tensorboard, debug=False):
        ...
        for step in range(horizon, 0, -1):
            ...
            optimal_policy_step, info = self.cb_oracle.learn_optimal_policy(cb_dataset,
            ...
            if debug:
                ...
                self.log_intermediate_results(cb_dataset, optimal_policy_step, env, actions, horizon,
        ...
        logger.log("FQI computational cost is %r sec. {Samples: %r, CB-Oracle: %r}" %
                   (fqi_step_time, (sample_time * 100.0) / fqi_step_time, (oracle_time * 100.0) / fqi_step_time))
