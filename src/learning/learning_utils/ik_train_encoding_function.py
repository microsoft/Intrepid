...
class IKTrainEncodingFunction:
    ...
    def train_model(self, dataset, logger, bootstrap_model, discretized, tensorboard):
        ...
        best_test_loss, best_epoch, train_loss = float('inf'), -1, float('inf')  # 0.69 is -log(2)
        ...
        for epoch_ in range(1, self.epoch + 1):
            ...
            for train_batch in train_batches:
                ...
                loss, info_dict = self.ik_learner.calc_loss(model, train_batch, epoch_, discretized,
                                                            test_set_errors, past_entropy)
            ...
            for test_batch in test_batches:
                ...
                _, info_dict = self.ik_learner.calc_loss(model, test_batch, epoch_,
        ...
        logger.log("Inverse kinematics (Discretized: %r), Train/Test = %d/%d, Best Tune Loss %r at max_epoch %r, "
